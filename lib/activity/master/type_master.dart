...
class TypeMasterActivity extends StatefulWidget {
  @override
  _TypeMasterActivityState createState() => _TypeMasterActivityState();
}

class _TypeMasterActivityState extends State<TypeMasterActivity> {
  ...
  Future<void> deleteType(String id, int index) async {
    Map<String, dynamic> param = {
      "idsToDelete": id,
      "api_name": "removeUserTypeProcess",
    };
    ...
    if (!IsData.status) {
      ...
      Share().show_Dialog(
          context, IsData.message, "Delete User Type", IsData.status);
      setState(() {
  ...
  Future<void> getUserType(bool status) async {
    print("user_type");
    Map<String, dynamic> param = {
      "type": "user_type",
    };
