...
import 'package:fepic_stock/activity/add_color.dart';
...
class ColorMasterActivity extends StatefulWidget {

  @override
  _ColorMasterActivityState createState() => _ColorMasterActivityState();


}

class _ColorMasterActivityState extends State<ColorMasterActivity> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: ()
            {
              Get.to(AddColor()).then((value) {
                getColorProduct(false);
              });
              // addDialog();
            },
          )
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 2,
                                          child: Text(
                                              snapshot.data[index].color_name.toString().toUpperCase(),
                                              style: TextStyle(
                                                  fontFamily: 'Libre',
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: SizeConfig
                                        ...
                                        Expanded(
                                          ...
                                          child: IconButton(
                                            ...
                                            onPressed: () {
                                              Get.to(AddColor(IsEditColor: true,colorDetail: snapshot.data[index],)).then((value) {
                                                getColorProduct(false);
                                              });
                                            },
                                          ),
  ...
  Future<void> deleteType(String id, int index) async {
    ...
    if (!IsData.status) {
      ...
      Share().show_Dialog(
          context, IsData.message, "Delete Color", IsData.status);
      /*  setState(() {
  ...
  Future<void> getColorProduct(bool status) async {

    Map<String, dynamic> param = {
      "type": "color_master",
      "other_table": "color_master"
    };
