...
class NewUserListActivity extends StatefulWidget {
  @override
  _NewUserListActivityState createState() =>
      _NewUserListActivityState();
}

class _NewUserListActivityState
    extends State<NewUserListActivity> {
  ...
  Future<void> getUserSession() async {
    ...
    getAllNewUserNotificationList(true,"");
  }
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return ListView.builder(
                          shrinkWrap: true,
                          itemCount: notificationModel.getNewUserNotificationList().length,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                notificationModel
                                                    .getNewUserNotificationList()[index]
                                          ...
                                          children: [
                                            RaisedButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                getNotificationDetail(notificationModel.getNewUserNotificationList()[index].notification_id,index);
                                              },
                                              child: Text(
                                                "Detail",
                                                style:
                                            ...
                                            SizedBox(width: 10,),
                                            notificationModel.getNewUserNotificationList()[index].notification_type=="SendChalan" ? RaisedButton(
                                              color: green,
                                              shape: RoundedRectangleBorder(
                                                  borderRadius:
                                                  BorderRadius.circular(20.0)),
                                              onPressed: () {
                                                notificationAccept(notificationModel.getNewUserNotificationList()[index].notification_id);
                                            ...
                                            notificationModel.getNewUserNotificationList()[index].notification_type=="SendChalan" ? RaisedButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                notificationReject(notificationModel.getNewUserNotificationList()[index].notification_id);
                                              },
                                              child: Text(
                                                "Reject",
                                                style:
  ...
  Future<void> getAllNewUserNotificationList(bool status,String search) async {
    message="";
    Map<String, dynamic> param = {
      "searchField":search,
  ...
  void _onChange(String value) {
    if (value.isNotEmpty) {
      if (value.length > 0) {
        getAllNewUserNotificationList(true,value);
      }
    }
  }
                ...
                builder: (BuildContext context, StateSetter setState1) {
                  return Column(
                    ...
                    children: [
                      ...
                      notificationModel.getNewUserNotificationList()[index].notification_type=="SendChalan" ?Row(
  ...
  Future<void> notificationAccept(String notification_id) async {
    ...
    MessageModelParam data = await messageModel
      ...
      if (value.status) {
        ...
        getAllNewUserNotificationList(false,"");
        //Share().error_message(scaffoldState, value.message,value.status);
